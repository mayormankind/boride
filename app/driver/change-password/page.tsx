...
export default function DriverChangePasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await authApi.driverChangePassword({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rider-bg via-white to-gray-50 pb-20">
      <div className="bg-gradient-to-r from-rider-primary to-rider-dark p-6 text-white flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-blue-100 text-sm mt-1">Update your account password</p>
        </div>
      </div>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Lock className="w-5 h-5 text-rider-primary" />
              Update Password
            </CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                className="w-full bg-rider-primary hover:bg-rider-dark h-12"
              >
