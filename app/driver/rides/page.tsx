      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <Tabs value={tab} onValueChange={(v) => setTab(v as any)}>
          <TabsList className="w-full grid grid-cols-2 mb-4">
            <TabsTrigger value="active" className="data-[state=active]:bg-rider-primary data-[state=active]:text-white">Active Ride</TabsTrigger>
            <TabsTrigger value="history" className="data-[state=active]:bg-rider-primary data-[state=active]:text-white">Ride History</TabsTrigger>
          </TabsList>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg mb-4">
                    ...
                    {activeRide.student?.phoneNo && (
                      <Button
                        ...
                        asChild
                      >
                        <a href={`tel:${activeRide.student.phoneNo}`}>
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{activeRide.dropoffLocation.address}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <Card key={ride._id}>
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <Badge
                          className={`${STATUS_CONFIG[ride.status as RideStatus]?.color ?? 'bg-gray-500'} text-white`}
                        >
